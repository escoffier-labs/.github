...
- [Token Glace](https://github.com/escoffier-labs/tokenjuice) - deterministic output compaction that trims terminal noise before it hits agent context; the Token Glace fork of vincentkoc/tokenjuice.
